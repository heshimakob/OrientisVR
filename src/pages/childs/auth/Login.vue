  ...
  <div class="flex flex-center">
    <div>
      <div class="q-mb-l q-mt-lg">
        <img src="others/24.jpg" class="q-mt-md" style="max-width: 150px" />
      </div>
      ...
      <div>
        ...
        <div class="q-mt-md q-mL-md tex-center flex row justify-between">
          <q-item class="caption tex-center">
            <span class="AFJcolor--g AFJfs--12">© 2022 Orientis, Inc.</span>
          </q-item>
          <q-btn
            class="AFJbtn--small"
            icon="eva-github"
            ...
            target="_blank"
            type="a"
            href="https://github.com/heshimakob/orieentis"
          ></q-btn>
        </div>
      </div>
    </div>
